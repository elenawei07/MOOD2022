...
def main():
    ...
    parser.add_argument('--checkpoint_dir',
                        type=str,
                        default='/home/data/WJ/MOOD2022/Reconstruction-by-inpainting-for-visual-anomaly-detection-main/Reconstruction-by-inpainting-for-visual-anomaly-detection-main/brain/seed_8811/brain_2022-08-24-4877_30_model.pt')
    ...
    test_data_path = '/home/data/WJ/MOOD2022/data/test_anamoly/brain/data'
    test_gt_path = '/home/data/WJ/MOOD2022/data/test_anamoly/brain/label'
    ...
    scores, test_imgs, recon_imgs,  gt_mask_list = test(args, model, test_loader)
...
def test(args, model, test_loader):
    ...
    return scores, test_imgs, recon_imgs,  gt_mask_list
...
def plot_fig(args, test_img, recon_imgs, scores, gts, threshold, save_dir):
    ...
    for i in range(num):
        ...
        fig_img.savefig(os.path.join(save_dir + '_{}.png'.format(i)), dpi=100)
        plt.close()
